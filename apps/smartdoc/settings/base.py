...
KEYCLOAK_MASTER_REALM = CONFIG.get('KEYCLOAK_MASTER_REALM')
KEYCLOAK_ADMIN_CLIENT_ID = CONFIG.get('KEYCLOAK_ADMIN_CLIENT_ID')
KEYCLOAK_ADMIN_USER = CONFIG.get('KEYCLOAK_ADMIN_USER')
KEYCLOAK_ADMIN_PWD = CONFIG.get('KEYCLOAK_ADMIN_PWD')
